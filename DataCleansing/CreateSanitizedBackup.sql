CREATE PROCEDURE [DataCleansing].[CreateSanitizedBackup]
...
AS
	...
	SET @TargetDatabaseName = '[' + @SourceDatabaseName + '_sanitized]'

	EXEC [DataCleansing].[CreateSanitizedCopy]  @SourceDatabaseName, @TargetDatabaseName
	...
	PRINT 'Your sanitized backup is at:'
	PRINT @BackupFile
